...
function temporaryWorkspaceRemediation() {
  return "Avoid a file by piping commands or using stdout when possible. Otherwise call temporary_workspace_create with no arguments, use its returned path, move retained outputs out, then call temporary_workspace_delete with the autogenerated ID."
}
