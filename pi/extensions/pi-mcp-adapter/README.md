...
> This local copy is based on [`nicobailon/pi-mcp-adapter`](https://github.com/nicobailon/pi-mcp-adapter), originally written by [Nico Bailon](https://github.com/nicobailon) and licensed under MIT. Local changes add configurable OAuth client metadata and redirect URI support.
