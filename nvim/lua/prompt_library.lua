local prompt_library = {
  ['Prompt Engineer'] = {
    strategy = 'chat',
    description = 'Creating detailed and effective prompts for LLMs.',
    opts = {
      short_name = 'prompt-engineer',
    ...
    prompts = {
      ...
      {
        role = 'user',
        content = 'I want you to write a prompt about',
        opts = {
          contains_code = true,
        },
      },
  ...
  ['Codegen Greenfield'] = {
    strategy = 'workflow',
    description = 'Use a conversational LLM to hone in on an idea',
    opts = {
      index = 4,
      is_default = true,
      short_name = 'cg',
    ...
    prompts = {
      {
        ...
        },
        {
          ...
          condition = function()
            return (vim.b.workflow_step or 0) == 0
          end,
        },
      },
      {
        {
          ...
          condition = function()
            return (vim.b.workflow_step or 0) == 1
          end,
        },
      },
      {
        {
          ...
          condition = function()
            return (vim.b.workflow_step or 0) == 2
          end,
        },
        {
          role = 'user',
          content = 'Can you make a `todo.md` that I can use as a checklist? Be thorough.',
          opts = {
            type = 'persistent',
          },
          condition = function()
            return (vim.b.workflow_step or 0) == 3
          end,
        },
      },
    },
